...
public struct Vec3 : IFlatbufferObject
{
  ...
  public static Offset<Kreoda.Protocol.Vec3> CreateVec3(FlatBufferBuilder builder,
      double x = 0.0,
      double y = 0.0,
      double z = 0.0) {
  ...
  public static Offset<Kreoda.Protocol.Vec3> EndVec3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Kreoda.Protocol.Vec3>(o);
  }
}
